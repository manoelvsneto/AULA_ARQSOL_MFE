...
import { _ as _extends, b as _extends$1, s as serializeStyles } from './emotion-use-insertion-effect-with-fallbacks.browser.esm-DnlfKrv4.js';
import { r as reactExports } from './index-De2ouyjm.js';
import { g as getAugmentedNamespace } from './_commonjsHelpers-BPPvcXt-.js';
import { c as createCache, T as ThemeContext, a as css, k as keyframes } from './emotion-react.browser.esm-CZ-bEcl9.js';
...
function deepClone(source) {
  if ( /*#__PURE__*/React$d.isValidElement(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge$1(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach(key => {
      if ( /*#__PURE__*/React$d.isValidElement(source[key])) {
...
function isMuiElement(element, muiNames) {
  ...
  return /*#__PURE__*/React$c.isValidElement(element) && muiNames.indexOf( // For server components `muiName` is avaialble in element.type._payload.value.muiName
 ...
 */
const useEnhancedEffect = typeof window !== 'undefined' ? React$b.useLayoutEffect : React$b.useEffect;

const React$a = await importShared('react');

let globalId = 0;
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React$a.useState(idOverride);
...
const maybeReactUseId = React$a['useId'.toString()];
/**
 *
...
function useControlled({
  ...
  } = React$9.useRef(controlled !== void 0);
  const [valueState, setValue] = React$9.useState(defaultProp);
  const value = isControlled ? controlled : valueState;
  const setValueIfUncontrolled = React$9.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useEventCallback(fn) {
  const ref = React$8.useRef(fn);
  useEnhancedEffect(() => {
    ref.current = fn;
  });
  return React$8.useRef((...args) =>
...
function useLazyRef(init, initArg) {
  const ref = React$6.useRef(UNINITIALIZED);
...
const PropsContext = /* @__PURE__ */ React$3.createContext(void 0);
...
function useDefaultProps$1({
  ...
  const ctx = React$3.useContext(PropsContext);
...
const require$$1$2 = /*@__PURE__*/getAugmentedNamespace(_extends$1);
...
var _extends2 = _interopRequireDefault$1(require$$1$2);
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ["all"], options = {}) => {
    const {
      ...
      delay = 0
    } = options; _objectWithoutPropertiesLoose(options, _excluded$2);
...
export { useDefaultProps as $, deepmerge$1 as A, capitalize$1 as B, composeClasses as C, DefaultPropsProvider as D, generateUtilityClass as E, isMuiElement as F, GlobalStyles as G, handleBreakpoints as H, resolveBreakpointValues as I, createUnarySpacing as J, mergeBreakpointsInOrder as K, getValue as L, createSpacing as M, createBreakpoints as N, createTheme as O, defaultTheme as P, private_safeDarken_1 as Q, private_safeLighten_1 as R, private_safeEmphasize_1 as S, THEME_ID as T, private_safeAlpha_1 as U, private_safeColorChannel_1 as V, defaultSxConfig as W, hslToRgb_1 as X, createTypography as Y, generateUtilityClasses as Z, _objectWithoutPropertiesLoose as _, useForkRef as a, duration as a0, useTimeout as a1, styled as a2, alpha_1 as a3, useControlled as a4, useIsFocusVisible as a5, useEventCallback as a6, createSvgIcon as a7, darken_1 as a8, lighten_1 as a9, setRef as aa, require$$1$1 as ab, ownerDocument as ac, ownerWindow as ad, debounce as ae, ClassNameGenerator as af, emphasize_1 as ag, rootShouldForwardProp as ah, createChainedFunction as ai, getPath as aj, slotShouldForwardProp as ak, Timeout as al, SvgIcon as am, StyledEngineProvider as an, createMuiTheme as ao, deprecatedPropType as ap, easing as aq, getSvgIconUtilityClass as ar, createMixins as as, requirePropFactory as at, svgIconClasses as au, unstable_ClassNameGenerator as av, unsupportedProp as aw, blue as b, clsx as c, common as d, grey as e, red as f, green as g, createTheme$2 as h, interopRequireDefaultExports as i, jsxRuntimeExports as j, internal_serializeStyles as k, lightBlue as l, styleFunctionSx$1 as m, extendSxProp as n, orange as o, purple as p, internal_processStyles as q, requireJsxRuntime as r, styled$1 as s, isPlainObject as t, utils as u, resolveProps as v, useEnhancedEffect as w, formatMuiErrorMessage$1 as x, clamp$1 as y, useId as z };
