...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BmEdZzZt.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CPzxiJYb.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'@mui/material':{get:()=>()=>__federation_import(new URL('__federation_shared_@mui/material-ChmWyyC2.js', import.meta.url).href),import:true},'@emotion/react':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/react-DKgGm33K.js', import.meta.url).href),import:true},'@emotion/styled':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/styled-BUHQoJUB.js', import.meta.url).href),import:true}};
